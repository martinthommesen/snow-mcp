...
|---|---|---|---|
| 2026-06-04 | pending | local | Source changes require production OIDC, scoped executor path, repository CodeQL default setup, hardened executor properties, reconciled verifier comments, and manual deployed OIDC E2E wiring; live sub-prod gates not run |
