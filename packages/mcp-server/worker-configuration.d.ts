/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc` (hash: 9385f84eaf50a2088c7513ea8d7ce3f1)
...
interface __BaseEnv_Env {
	...
	AUTH_DO: DurableObjectNamespace<import("./src/index").AuthCorrelationDO>;
	...
	MCP_ADMISSION_DO: DurableObjectNamespace<import("./src/index").McpAdmissionDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AuthCorrelationDO" | "TokenStoreDO" | "BudgetDO" | "MutationLedgerDO" | "ConsentRateDO" | "McpAdmissionDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEPLOYMENT_PROFILE">> {}
}
